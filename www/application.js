...
let connectStatus;
let resultLabel; //ç»“æžœæ˜¾ç¤ºæ ‡ç­¾
let connectButton; //è¿žæŽ¥æŒ‰é’®
let configGroup; //é…ç½®åŒºåŸŸ
let resultGroup; //ç»“æžœåŒºåŸŸ
let port;
...
let from = 0; //è¡¨ç›˜èŒƒå›´
let to = 0.16;
let centerPointConfig, //åæ ‡é…ç½®æŒ‰é’®ç”Ÿæ•ˆ
    startPointConfig,
    endPointConfig = false;
let center = [0, 0], //é€‰ä¸­çš„åæ ‡
    start = [0, 0],
    end = [0, 0];
// let timestamp = 0;
let precision = 2; //è¾“å‡ºç»“æžœç²¾åº¦
let result = 0;
let rotate = IMG_ROTATION_NORMAL;
